...
- [Database Documentation (ER Diagram + Example Tables)](docs/DATABASE.md)
- [Standalone ER Diagram (Models DB)](docs/ER_DIAGRAM.md)
- [Models Documentation (Markdown)](docs/MODELS_DOCUMENTATION.md)
- [Models Documentation (PDF)](docs/MODELS_DOCUMENTATION.pdf)
- [HTML Function Main Code (Markdown)](docs/HTML_FUNCTIONS_MAIN_CODE.md)
- [HTML Function Main Code (PDF)](docs/HTML_FUNCTIONS_MAIN_CODE.pdf)
- [HTML Data Display Code (Markdown)](docs/HTML_DATA_DISPLAY_CODE.md)
- [HTML Data Display Code (PDF)](docs/HTML_DATA_DISPLAY_CODE.pdf)
- [Function Code Documentation (Markdown)](docs/FUNCTION_CODE_DOCUMENTATION.md)
- [Function Code Documentation (PDF)](docs/FUNCTION_CODE_DOCUMENTATION.pdf)
- [User Guide](docs/USER_GUIDE.md)
- [Bug Report (Static Audit)](docs/BUG_REPORT.md)
